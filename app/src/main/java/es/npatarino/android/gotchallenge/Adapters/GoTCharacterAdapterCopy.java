 ...
 */
public class GoTCharacterAdapterCopy extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private ArrayList<GoTCharacter> charactersArray;
    private Activity activity;

    public GoTCharacterAdapterCopy(Activity activity, ArrayList<GoTCharacter> characters) {
